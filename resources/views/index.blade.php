        ...
        <main class="w-full flex flex-col items-center">
            <section class="w-full flex flex-col items-center">
                ...
                <nav
                    ...
                    {{-- Здесь будут динамически загружаться категории из БД --}}
                    @forelse($categories as $category)
                        <a href="{{ route('catalog', ['category' => $category->slug]) }}"
                            class="flex items-center gap-2 px-4 whitespace-nowrap">
                            @if($category->icon) {{-- Используем $category->icon для проверки наличия пути --}}
                                <img src="{{ asset('storage/' . $category->icon) }}" {{-- asset() сработает через символическую
                                    ссылку --}} alt="{{ $category->name }}" class="w-10 h-10 object-contain" />
                            @else
                                {{-- Плейсхолдер, если изображения для категории нет --}}
                                <div
                                    class="w-10 h-10 flex items-center justify-center bg-neutral-600 rounded text-sm text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                        stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M9.75 3.104v5.385m-3.269 8.272l-1.392 4.398m0 0l16.51 1.776m-16.51-1.776h16.51l2.64-1.632a.75.75 0 00.046-1.092l-1.4-1.4m0 0h-4.224m5.275-4.505c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2ZM4.49 19.349h1.392m0-0c.466 1.394 1.778 2.392 3.308 2.392 1.53 0 2.842-.998 3.308-2.392m0 0h6.143M3.27 12.67l-1.4 4.399h19.53l-1.4-4.399" />
                                    </svg>
                                </div>
                            @endif
                    ...
                    @empty
                        <p class="text-gray-400">Категории пока не добавлены.</p>
                    @endforelse
                </nav>
            </section>
            ...
            <section class="w-full flex flex-col items-center">
                ...
                hover:border-white hover:bg-neutral-600 cursor-pointer h-full border-neutral-600 text-zinc-400 max-md:pl-5 max-md:mt-10">
                                ...
                                <img src="/images/raspr.png" alt="Venum equipment"
                ...
                hover:border-white hover:bg-neutral-600 cursor-pointer h-full border-neutral-600 text-zinc-400 max-md:px-5 max-md:mt-10">
                                ...
                                <img src="/images/post.png" alt="New arrival"
                                    class="object-contain shrink-0 self-start mt-3 max-w-full aspect-[1.25] w-[35%]" />
                            </div>
                        </article>

                        <article class="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                            <div class="product-card flex grow gap-3.5 p-8 text-xl font-semibold rounded-md border border-solid border-neutral-600
                hover:border-white hover:bg-neutral-600 cursor-pointer h-full text-zinc-400 max-md:px-5 max-md:mt-10">
                                ...
                                <img src="/images/jst.png" alt="Jason Statham"
            ...
            <section class="w-full flex flex-col items-center">
                <h2 class="mt-20 ml-5 text-4xl text-white max-md:mt-10 max-md:max-w-full">
                ...
                <div class="mt-8 ml-20 max-w-full w-[823px]">
                    <div class="flex gap-5 max-md:flex-col">
                        <div class="w-6/12 max-md:ml-0 max-md:w-full">
                            <img src="/images/opt.png" alt="Sports motivation"
                ...
                <div class="flex flex-wrap gap-10 mt-11 max-w-full text-white w-[1187px] max-md:mt-10">
                    <a href="product/sorty-manto-muzskie" class="flex-1">
                        <article
                            ...
                            <img src="/images/short_manto.png" alt="Шорты manto"
                    ...
                    <a href="/product/kurtka-redfox" class="flex-1">
                        <article
                            ...
                            <img src="/images/redfox1.png" alt="Куртка RedFox"
                    ...
                    <a href="/product/krossovki-salomon-muzskie" class="flex-1">
                        <article
                            ...
                            <img src="/images/kr_salomon1.png" alt="Кроссовки salomon"
                    ...
                    <a href="/product/sorty-puma" class="flex-1">
                        <article
                            ...
                            <img src="/images/sh_puma.png" alt="Шорты puma"
                    ...
                    <a href="/product/sorty-salomon-zenskie" class="flex-1">
                        <article
                            ...
                            <img src="/images/sh_salomon.png" alt="Шорты salomon (ж)"
